        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <a href="javascript:void(0)" class="overlay-img">
                    <img src="../public/images/cockpitSoir.jpg" alt="">  
            ...
            <div class="col-md-4">
                <a href="javascript:void(0)" class="overlay-img">
                    <img src="../public/images/savanahMontagne.jpg" alt="">  
                    <div class="overlay"></div> 
                    <div class="des">
            ...
            <div class="col-md-4">
                <a href="javascript:void(0)" class="overlay-img">
                    <img src="../public/images/avitaillementDylan.jpg" alt="">  
                    <div class="overlay"></div> 
                    <div class="des">
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <a href="javascript:void(0)" class="card">
                    <img src="../public/images/colineEtretat1.jpg" class="card-img" alt="">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <a href="javascript:void(0)" class="card">
                    <img src="../public/images/castelLoire1.jpg" class="card-img" alt="">
                    <div class="card-body">
